...
namespace iVeiOTA {
  ...
  struct Message::_ManagementMessage     iVeiOTA::Message::Management;
  struct Message::_OTAUpdateMessage      iVeiOTA::Message::OTAUpdate;
  struct Message::_OTAStatusMessage      iVeiOTA::Message::OTAStatus;
  struct Message::_BootManagementMessage iVeiOTA::Message::BootManagement;

  // Our sync message
  const uint8_t  Message::sync[] = {'i', 'V', 'e', 'i', 'O', 'T', 'A', '\0'};
  ...
  std::string Message::Header::toString() const {
    ...
    case Message::OTAUpdate:      ss << Message::OTAUpdate.toString(subType);      break;
    case Message::OTAStatus:      ss << Message::OTAStatus.toString(subType);      break;
    case Message::BootManagement: ss << Message::BootManagement.toString(subType); break;

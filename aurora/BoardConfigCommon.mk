...
BOARD_SEPOLICY_DIRS += device/xilinx/aurora/sepolicy

DEVICE_MANIFEST_FILE := device/xilinx/aurora/manifest.xml
DEVICE_MATRIX_FILE := device/xilinx/aurora/compatibility_matrix.xml
